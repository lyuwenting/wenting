...
dat=exprs(a) 
pd=pData(a) 
colnames(dat)=c("HC1","HC2","HC3","HC4","HC5","HC6","IPF1","IPF2","IPF3","IPF4","IPF5","IPF6",
                "IPF7","IPF8","IPF9","IPF10","IPF11","IPF12","IPF13","IPF14","IPF15","IPF16","IPF17")
sample<-c("HC1","HC2","HC3","HC4","HC5","HC6","IPF1","IPF2","IPF3","IPF4","IPF5","IPF6",
         "IPF7","IPF8","IPF9","IPF10","IPF11","IPF12","IPF13","IPF14","IPF15","IPF16","IPF17")
gr<-c("HC","HC","HC","HC","HC","HC","IPF","IPF","IPF","IPF","IPF","IPF",
      "IPF","IPF","IPF","IPF","IPF","IPF","IPF","IPF","IPF","IPF","IPF")
group<-data.frame(sample,gr)
group_list=as.character(group[,2])
GPL=getGEO(filename = 'GSE24206_family.soft.gz')
...
length(unique(ids$symbol))#注释包的探针数目
...
##筛选的热图
nrDEG2=nrDEG[c("KMT2A","KMT2B","KMT2C","KMT2D","EP300"),]
nrDEG3=head(nrDEG,20)
nrDEG4=rbind(nrDEG3,nrDEG2)
library(pheatmap)
choose_gene=head(rownames(nrDEG4),25)
choose_matrix=exprSet[choose_gene,]
choose_matrix=t(scale(t(choose_matrix)))
pheatmap(choose_matrix)
